<div class="flex min-h-screen">
   ...
   class="flex items-center py-2 px-4 mb-4 rounded-md transition 
   {{ Request::is('admin/dashboard') ? 'bg-blue-600 text-white' : 'text-blue-600 hover:bg-blue-600 hover:text-white' }}">
...
<a href="{{ route('admin.users') }}" 
   class="flex items-center py-2 px-4 mb-4 rounded-md transition 
   {{ Request::is('admin/users') ? 'bg-blue-600 text-white' : 'text-blue-600 hover:bg-blue-600 hover:text-white' }}">
...
<a href="{{ route('admin.reports') }}" 
   class="flex items-center py-2 px-4 mb-4 rounded-md transition 
   {{ Request::is('admin/reports') ? 'bg-blue-600 text-white' : 'text-blue-600 hover:bg-blue-600 hover:text-white' }}">
    <i class="fas fa-file-alt mr-2"></i>
    <span>Kelola Laporan</span>
</a>

<a href="{{ route('rewards.index.admin') }}" 
   class="flex items-center py-2 px-4 mb-4 rounded-md transition 
   {{ Request::is('admin/rewards') ? 'bg-blue-600 text-white' : 'text-blue-600 hover:bg-blue-600 hover:text-white' }}">
